...
class HTMega_Elementor_Widget_User_Login_Form extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Login Form Header Style', 'htmega-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition'=>[
                    'show_loginform_heading'=>'yes',
                ],
        ...
        $this->start_controls_section(
            ...
            // $this->add_responsive_control(
            //     'login_form_input_rememberme_label_margin',
            //     [
            //         'label' => __( 'Label Margin', 'htmega-addons' ),
            //         'type' => Controls_Manager::DIMENSIONS,
            //         'size_units' => [ 'px', '%', 'em' ],
            //         'selectors' => [
            //             '{{WRAPPER}} .htmega-login-form-style-1 form label' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            //         ],
            //         'separator' =>'before',
            //     ]
            // );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Forget Text', 'htmega-addons' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            $this->start_controls_tabs('login_form_style_register_tabs');
                ...
                $this->start_controls_tab(
                    ...
                    // $this->add_responsive_control(
                    //     'login_form_register_button_margin',
                    //     [
                    //         'label' => __( 'Margin', 'htmega-addons' ),
                    //         'type' => Controls_Manager::DIMENSIONS,
                    //         'size_units' => [ 'px', '%', 'em' ],
                    ...
                    // $this->add_control(
                    //     'login_form_register_button_height',
                    //     [
                    //         'label' => __( 'Height', 'htmega-addons' ),
                    //         'type' => Controls_Manager::SLIDER,
                    //         'size_units' => [ 'px', '%' ],
