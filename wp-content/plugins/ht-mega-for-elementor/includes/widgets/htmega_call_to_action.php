...
class HTMega_Elementor_Widget_Call_To_Action extends Widget_Base {
    ...
    protected function render( $instance = [] ) {
        ...
        if ( ! empty( $settings['callto_action_button_link_second']['url'] ) ) {
            ...
            $this->add_render_attribute( 'urlscnd', 'href', $settings['callto_action_button_link_second']['url'] );

            if ( $settings['callto_action_button_link_second']['is_external'] ) {
                $this->add_render_attribute( 'urlscnd', 'target', '_blank' );
            }

            if ( ! empty( $settings['callto_action_button_link_second']['nofollow'] ) ) {
                $this->add_render_attribute( 'urlscnd', 'rel', 'nofollow' );
            }
        }
