...
class HTMega_Elementor_Widget_ImageMarker extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'marker_section',
            [
                'label' => __( 'Marker Item', 'htmega-addons' ),
            ...
            $this->add_control(
                ...
                [
                    'label'   => __( 'Hidden Field', 'htmega-addons' ),
                    'type'    => Controls_Manager::HIDDEN,
                    'default' => 'marker_style_selector',
                ]
            );
            ...
            $repeater->start_popover();
                ...
                $repeater->add_responsive_control(
                    ...
                    [
                        'label' => __( 'Marker Content Postion(X)', 'htmega-addons' ),
                        'type' => Controls_Manager::SLIDER,
                        'size_units' => [ 'px', '%' ],
                        'range' => [
                            'px' => [
                ...
                $repeater->add_responsive_control(
                    ...
                    [
                        'label' => __( 'Marker Content Postion(Y)', 'htmega-addons' ),
                        'type' => Controls_Manager::SLIDER,
                        'size_units' => [ 'px', '%' ],
                        'range' => [
                            'px' => [
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'return_value'  => 'yes',
                    'default'       => 'no',
                    'prefix_class' => 'htmega-marker-indicator-',
                    'separator' => 'before',
                ]
            );
            ...
            $repeater->add_control(
                'not_registration_yat_notice',
                [
                    'label' => esc_html__( 'Aleart Note', 'htmega-addons' ),
                    'type' => Controls_Manager::RAW_HTML,
                    'raw' => __( 'Reload the editor right after enabling this option. Example: Enable/Disable this option > Click UPDATE > Then Reload the editor page.', 'htmega-addons' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'marker_icon_indicator_toggle',
                [
                    'label' => __( 'Marker Indicator Style', 'htmega-addons' ),
                    'type' => Controls_Manager::POPOVER_TOGGLE,
                    'label_off' => __( 'None', 'htmega-addons' ),
                    'label_on' => __( 'Custom', 'htmega-addons' ),
                    'return_value' => 'yes',
            ...
            $this->start_popover();
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .htmega-marker-style-6 .htmega-image-marker-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
                            '{{WRAPPER}} .htmega-marker-style-6 .htmega-image-marker-icon svg' => 'width: {{SIZE}}{{UNIT}};',
                        ],
                    ]
                );
                ...
                $this->add_responsive_control(
                    'marker_icon_width',
                    [
                        'label' => __( 'Indicator Width', 'htmega-addons' ),
                        'type' => Controls_Manager::SLIDER,
                        'size_units' => [ 'px', '%' ],
                        'range' => [
                            'px' => [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .htmega-marker-style-6 .htmega_image_pointer' => 'width: {{SIZE}}{{UNIT}};',
                        ],
                    ]
                );
                ...
                $this->add_responsive_control(
                    'marker_icon_height',
                    [
                        'label' => __( 'Indicator Height', 'htmega-addons' ),
                        'type' => Controls_Manager::SLIDER,
                        'size_units' => [ 'px', '%' ],
                        'range' => [
                            'px' => [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .htmega-marker-style-6 .htmega_image_pointer' => 'height: {{SIZE}}{{UNIT}};',
                        ],
                    ]
                );

                $this->add_responsive_control(
                    'marker_icon_line_height',
                    [
                        'label' => __( 'Indicator Line Height', 'htmega-addons' ),
                        'type' => Controls_Manager::SLIDER,
                        'size_units' => [ 'px', '%' ],
                        'range' => [
                            'px' => [
                        ...
                        'selectors' => [
                            '{{WRAPPER}} .htmega-marker-style-6 .htmega_image_pointer' => 'line-height: {{SIZE}}{{UNIT}};',
                        ],
                    ]
                );
        ...
        ?>
            <div <?php echo $this->get_render_attribute_string('htmega_image_marker_attr'); ?> >
                ...
                <?php
                    ...
                    ?>
                        <div class="htmega_image_pointer elementor-repeater-item-<?php echo esc_attr( $item['_id'] );?> htmega-marker-content-position-<?php echo esc_attr( $item['marker_content_position_offset'] ); ?> htmega-marker-content-position-<?php echo esc_attr( $item['content_indicator_section'] ); ?>">
                            <?php 
                            
                                if( '6' == $settings['marker_style'] ){
                                    ?>
                                        <div class="htmega-image-marker-icon">
                                        <?php echo HTMega_Icon_manager::render_icon( $item['marker_indicator_icon'], [ 'aria-hidden' => 'true' ] ); ?>
                                        </div>
                                    <?php 
                                }
                            ?>
