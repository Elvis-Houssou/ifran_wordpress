...
== ✅ Template Library: ==
Choose your page layout from template list. You can easily import the template with a single click. There are 15 Templates available in the free version, while the pro version contains a whopping collection of 524 templates.
...
84. **[WooCommerce Checkout Page](https://wphtmega.com/widget/element-checkout-page/)** - The Woocommerce Checkout widget helps you finetune your WooCommerce checkout page layout with ease. It comes with a plethora of options to embellish your WooCommerce checkout page.
...
The pro version of HT Mega Elementor Addons gives you access to numerous incredible features that include 39 Categories / Template Sets, 524 Page Templates, Cross-Domain Copy Paste, Blog Search Page Builder, Sales Upto Date Option, and many more.
